        ...
        <div class="col-md-6">
            <form action="baja_usuario_sql.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="clave" name="clave" class="form-control" value="<?php echo $clave ?>" required readonly>
                </div>
                <div class="form-group">
                    <label for="roles">Rol del Usuario:</label>
                    <input type="text" id="roles" name="roles" class="form-control" value="<?php echo $clave ?>" required readonly>
                </div>
                <hr style="border-top: 2px solid black;">
                <button type="submit" class="btn btn-success btn-block" name="btn" value="1">Borrar</button>
